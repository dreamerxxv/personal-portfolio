        ...
        <section id="footer">
            <div className="container">
                ...
                <ul className="list-inline margintop-sm">
                    ...
                    <li className="list-inline-item"><a href="https://github.com/dreamerxxv"><i className="fa-brands fa-github"></i></a></li>
                    <li className="list-inline-item"><a href="https://api.whatsapp.com/send?phone=6289512876120"><i className="fa-brands fa-whatsapp"></i></a></li>
